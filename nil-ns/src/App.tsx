...
export default function App() {
  ...
  return (
    <div className="p6 h-full w-full bg-slate-800">
      ...
      <div className='bg-slate-800 h-1/2 p-12 flex justify-center items-center'>
        <div className='w-1/2 h-1/6 text-center shadow-lg rounded-2xl shadow-emerald-400 flex'>
          <input className='rounded-s-xl text-2xl bg-slate-800 w-3/4 h-full text-center focus:border-emerald- focus:outline-none'
            ref={nilNameInputRef}
            value={nilNameText}
            ...
            placeholder='you.nil'
          ></input>
          <button className='bg-slate-700 rounded-r-xl w-1/4 h-full text-center duration-200 ease-out hover:bg-slate-500'
          onClick={() => { 
            if (!nilNameText) {
              return 
            } else {
